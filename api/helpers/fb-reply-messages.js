...
module.exports = {
  ...
  friendlyName: 'fb Reply Messages',


  description: 'Trả lời tin nhắn cho khách hàng',
  ...
  fn: async function (inputs, exits) {
    ...
    //https://developers.facebook.com/docs/messenger-platform/reference/send-api/
          if(inputs.type =='image'){
              ...
              var data_post = {                
                "message":JSON.stringify(inputs.content)
              }
           ...
           var page_url=  'https://graph.facebook.com/v3.0/'+inputs.messageId+'/messages?access_token='+inputs.token;
