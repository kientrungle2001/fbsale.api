...
module.exports = {
  ...
  fn: async function (inputs, exits) {
    // Lấy danh sách các bài viết của page
           var page_url=  'https://graph.facebook.com/v3.0/'+inputs.pageId+'/feed?fields=likes{id,name,pic_large},comments{comments{id,message,attachment,likes{id,name,pic_large},created_time,from{id,name,picture{url}}},id,message,attachment,likes{id,name,pic_large},from{id,name,picture{url}}},id,message,full_picture&access_token='+inputs.token;
