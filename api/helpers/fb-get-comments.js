...
module.exports = {
  ...
  fn: async function (inputs, exits) {
    // Lấy danh sách các comments của bài viết 
           var page_url=  'https://graph.facebook.com/v3.0/'+inputs.postId+'/comments?fields=id,messsage,full_picture,from{id,name,picture{url}},attachment,created_time,updated_time&access_token='+inputs.token;
