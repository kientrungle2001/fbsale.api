...
module.exports = {
  ...
  //link test( method: GET): /2125248527733637/conversations?fields=id,messages{message}
  fn: async function (inputs, exits) {
    // Lấy danh sách các bài tin nhắn của page  
  
           var page_url=  'https://graph.facebook.com/v3.0/'+inputs.pageId+'/conversations?fields=id,messages{message}&access_token='+inputs.token;
